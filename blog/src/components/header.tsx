  ...
  const options = [
    {
      ...
      icon:
        value === '/home' ? (
          <HomeIcon width={iconWidth} height={iconHeight} />
        ) : (
          <HomeOutlineIcon width={iconWidth} height={iconHeight} />
        ),
    },
    {
      value: '/article',
      ...
      icon:
        value === '/article' ? (
          <ClipboardDocumentListIcon width={iconWidth} height={iconHeight} />
        ) : (
          <OutlineClipboardDocumentListIcon
            width={iconWidth}
            height={iconHeight}
          />
        ),
    },
    {
      ...
      icon:
        value === '/about' ? (
          ...
          <OutlineUserIcon width={iconWidth} height={iconHeight} />
        ),
    },
  ];
